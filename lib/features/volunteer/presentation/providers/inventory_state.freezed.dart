...
mixin _$InventoryState {
 ...
 List<Shelf> get shelves; List<Donation> get donations; bool get isLoadingShelves; bool get isLoadingDonations; bool get isDownloading; String? get errorMessage; String? get successMessage;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is InventoryState&&const DeepCollectionEquality().equals(other.shelves, shelves)&&const DeepCollectionEquality().equals(other.donations, donations)&&(identical(other.isLoadingShelves, isLoadingShelves) || other.isLoadingShelves == isLoadingShelves)&&(identical(other.isLoadingDonations, isLoadingDonations) || other.isLoadingDonations == isLoadingDonations)&&(identical(other.isDownloading, isDownloading) || other.isDownloading == isDownloading)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage)&&(identical(other.successMessage, successMessage) || other.successMessage == successMessage));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(shelves),const DeepCollectionEquality().hash(donations),isLoadingShelves,isLoadingDonations,isDownloading,errorMessage,successMessage);

@override
String toString() {
  return 'InventoryState(shelves: $shelves, donations: $donations, isLoadingShelves: $isLoadingShelves, isLoadingDonations: $isLoadingDonations, isDownloading: $isDownloading, errorMessage: $errorMessage, successMessage: $successMessage)';
}
...
@useResult
$Res call({
 List<Shelf> shelves, List<Donation> donations, bool isLoadingShelves, bool isLoadingDonations, bool isDownloading, String? errorMessage, String? successMessage
});
...
/// Create a copy of InventoryState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? shelves = null,Object? donations = null,Object? isLoadingShelves = null,Object? isLoadingDonations = null,Object? isDownloading = null,Object? errorMessage = freezed,Object? successMessage = freezed,}) {
  return _then(_self.copyWith(
shelves: null == shelves ? _self.shelves : shelves // ignore: cast_nullable_to_non_nullable
...
class _InventoryState implements InventoryState {
  const _InventoryState({final  List<Shelf> shelves = const [], final  List<Donation> donations = const [], this.isLoadingShelves = true, this.isLoadingDonations = true, this.isDownloading = false, this.errorMessage, this.successMessage}): _shelves = shelves,_donations = donations;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _InventoryState&&const DeepCollectionEquality().equals(other._shelves, _shelves)&&const DeepCollectionEquality().equals(other._donations, _donations)&&(identical(other.isLoadingShelves, isLoadingShelves) || other.isLoadingShelves == isLoadingShelves)&&(identical(other.isLoadingDonations, isLoadingDonations) || other.isLoadingDonations == isLoadingDonations)&&(identical(other.isDownloading, isDownloading) || other.isDownloading == isDownloading)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage)&&(identical(other.successMessage, successMessage) || other.successMessage == successMessage));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_shelves),const DeepCollectionEquality().hash(_donations),isLoadingShelves,isLoadingDonations,isDownloading,errorMessage,successMessage);
...
/// Create a copy of InventoryState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? shelves = null,Object? donations = null,Object? isLoadingShelves = null,Object? isLoadingDonations = null,Object? isDownloading = null,Object? errorMessage = freezed,Object? successMessage = freezed,}) {
  return _then(_InventoryState(
shelves: null == shelves ? _self._shelves : shelves // ignore: cast_nullable_to_non_nullable
